...
typewriter
  .pauseFor(0)
  .changeDelay(35)
  .typeString("Moi c'est Amr Abd El Fattah")
  .pauseFor(500)
  .typeString("<strong>, Développeur auto-didacte</strong>")
  .pauseFor(500)
  .deleteChars(12)
  .typeString('<span style = "color: #e72555;"> CSS </span>')
  .pauseFor(500)
  .deleteChars(5)
  .typeString('<span style = "color: rgba(0, 26, 255, 0.767);"> JS </span>')
  .start();
